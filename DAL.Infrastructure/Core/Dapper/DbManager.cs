...
namespace DAL.Infrastructure.Core
{
    public class DbManager : IDbManager
    {
        ...
        {
            Dapper.SqlMapper.ITypeHandler handler;
            return this.SetParameter(name, value, SqlMapper.LookupDbType(value.GetType(), name,false,out handler), ParameterDirection.Input, null);
        }
